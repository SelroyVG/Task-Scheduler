...
В ином случае дочерний процесс спит до наступления момента запуска, после чего выполняет команду, записывает информацию об этом в базу данных, записывает весь вывод команды пользователя в файл .logs/output и завершает свою работу сразу после выполнения команды. 
